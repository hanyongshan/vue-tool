...
<div
  class="hm-input"
  :class="{'hm-input--suffix': this.clearable || this.showPassword}"
>
  <span
...
```html
<hm-switch v-model="value" active-color="#13ce66" inactive-color="#ff4949">
</hm-switch>
```
...
<template>
  <label class="hm-radio">
    ...
    <span class="hm-radio__label"> 我是label </span>
  </label>
</template>
```
...
```html
export default { name: 'HmRadioGroup', provide () { return { RadioGroup: this }
}, props: { value: null } }
```
