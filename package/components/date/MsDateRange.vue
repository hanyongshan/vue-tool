...
/* 
props：
innerWidth：宽可以输入纯数字也可以输入百分比
limitDateNow：是否限制为不超过今天 true/false
ifSeconds：是否显示秒 true/false

events：
setDate(dateStart, dateEnd)  设置日期的值
getDateStart  获取左组件的日期
getDateEnd   获取右组件的日期

eventDateChange  日期值发生改变事件
*/
